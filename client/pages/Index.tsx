...
export default function Index() {
  return (
    <div className="relative">
        ...
        <div className="mx-auto max-w-7xl px-4 pb-24 pt-40 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-4 text-xl text-muted-foreground">
              We’re cooking up something special. Zipplit is coming soon to
              Kochi.
            </p>
            ...
            <a
              href="#better"
              className="mt-16 inline-flex items-center gap-2 text-sm text-foreground/70 hover:text-foreground"
            >
      ...
      <section
        id="better"
        className="relative mx-auto -mt-8 max-w-7xl px-4 sm:px-6 lg:px-8"
      >
            ...
            {[
              {
                emoji: "🍱",
                title: "Meals",
                desc: "Cloud Kitchen meals from ₹49",
              },
              {
                emoji: "🐟",
                title: "Seafood",
                desc: "Fresh catch & hot meals",
              },
      ...
      <section
        id="gold"
        className="relative mt-24 bg-neutral-950 py-20 text-neutral-100"
      >
        <div
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="font-display text-3xl font-extrabold">
              <span className="text-white">zipplit</span>{" "}
              <span className="gold-text">GOLD</span>
            </div>
            <p className="mt-2 text-neutral-300">
              Enjoy a world full of benefits with one membership
            </p>
            <div className="mt-6 text-sm tracking-widest text-neutral-400">
              ★ GOLD BENEFITS ★
            </div>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm tracking-widest text-neutral-500">
            POWERING KOCHI'S CHANGING LIFESTYLE
          </p>
        </div>
        <div className="mx-auto mt-10 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            {
              name: "zipplit",
              desc: "Order fresh seafood and budget cloud kitchen meals from Kochi's best delivery app",
            },
            {
              name: "blinkit",
              desc: "Get groceries delivered to your doorstep in minutes from our quick commerce platform",
            },
            {
              name: "district",
              desc: "Discover and book the best dining, entertainment, and wellness experiences",
            },
            {
              name: "hyperpure",
              desc: "Quality ingredients and supplies for restaurants, delivered fresh every day",
            },
          ].map((b) => (
        ...
        <div className="grid grid-cols-1 gap-8 rounded-3xl bg-gradient-to-b from-accent to-white p-8 md:grid-cols-2 md:p-12">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Zipplit app is coming soon. Join the waitlist and we’ll notify you
              when we launch.
            </p>
            <WaitlistForm />
          </div>
